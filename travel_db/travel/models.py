...
class Flights(models.Model):
	...
	sclass=models.CharField(max_length=100,blank=False,choices=sclass_choices, default='Economy')"""
	class Meta:
...
class Itinerary (models.Model):
	place=models.CharField(max_length=100,blank=False)
	attractions=models.CharField(max_length=100,blank=False)
	visiting_day=models.PositiveIntegerField(blank=False)
	in_time=models.PositiveIntegerField(blank=False)
	out_time=models.PositiveIntegerField(blank=False)
	ticket_cost=models.PositiveIntegerField(blank=False)
	class Meta:
		db_table="itinerary"
