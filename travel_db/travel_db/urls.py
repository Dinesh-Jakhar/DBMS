...
urlpatterns = [
    ...
    path("view_seats_flight/<str:flight>",views.viewseats_flight,name="viewseats_flight"),
    path("paymentpage/<str:travels>/<int:id>",views.paymentpage,name="paymentpage"),
   path("paymentpage_flights/<str:flight>/<int:id>",views.paymentpage_flights,name="paymentpage"),
